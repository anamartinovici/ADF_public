...
Sometimes you might want to personalize the style you're using in the output document. Then, you can use a `.css` file where you store information about these styles. Check `.\examples\how_to_Rmd\sections\style.css`, which is the file I'm using to create the info box below. Notice how this allows me to make the recommendation even more visually salient than text formatting alone.
